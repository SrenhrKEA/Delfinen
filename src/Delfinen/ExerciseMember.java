...
public class ExerciseMember extends Member {
  ...
  public ExerciseMember(Integer age, String name, String address, String email, String telephone, String dateRegistration, String id, Gender gender, MembershipType type, MembershipStatus status) {
